var JSONFormat = (function () {
    ...
    _JSONFormat.prototype = {
        constructor: JSONFormat, toString: function () {
...
(function request_intercept(args) {
    var $result_container = args[0], $result = args[1];
    $('form *[type="submit"]').bind('click', function () {
        var _form = $(this).parents('form'), _action = (_form.attr('action') || './'), _method = (_form.attr('method') || 'get').toLowerCase(), _params = {};
